...
const STATIC_ASSETS = [
    ...
    '/craps-strategy/app.js?v=5',
    '/craps-strategy/style.css?v=3',
    '/craps-strategy/strategy.js?v=3',
    '/craps-strategy/engine.js?v=4',
    '/craps-strategy/manifest.json',
    '/craps/crapsRules.js?v=2',
    '/shared/casino-theme.css?v=3',
    '/shared/site-nav.css?v=15',
    '/shared/site-nav.js?v=18',
