...
(function () {
    ...
    function setBoardMode(mode) {
        ...
        if (!week) {
            ...
            if (els.marketBoardEyebrow) els.marketBoardEyebrow.textContent = "Market value";
            if (els.marketBoardTitle) els.marketBoardTitle.textContent = "Season Board";
        }
    ...
    function renderMemberSnapshot(data) {
        ...
        teamLink.href = `/fantasy/?season=${encodeURIComponent(state.season)}` +
