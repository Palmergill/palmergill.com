(function () {
    ...
    const icons = {
        ...
        "dice-5": '<rect width="18" height="18" x="3" y="3" rx="3"/><path d="M8 8h.01"/><path d="M16 8h.01"/><path d="M12 12h.01"/><path d="M8 16h.01"/><path d="M16 16h.01"/>',
        "diamond-suit": '<path d="M12 2.7 18.4 12 12 21.3 5.6 12 12 2.7Z"/>',
    ...
    function init() {
        ...
        const links = renderLinks(items);
        const utilityLinks = renderLinks(utilityItems);
