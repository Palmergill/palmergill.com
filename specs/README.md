...
| 17 | [ESPN league hub](q3-17-espn-league-hub.md) | in progress — P1–P6 built (data, hub, rosters, AI, start/sit, free agents); needs a live OpenAI key to verify model-backed overviews |
