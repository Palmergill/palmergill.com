...
| 17 | [ESPN league hub](q3-17-espn-league-hub.md) | in progress — P1–P6 built (data, hub, rosters, AI, start/sit, free agents), hub promoted to `/fantasy/` Sep 2026; needs a live OpenAI key to verify model-backed overviews, and multi-league import is still backend-only work |
